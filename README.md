...
<details>
 ...
 <p><em>YouSpeed is available only in next pre-built IPAs or in your personal build.</em></p>
 <p>View "How to build a YouTube Plus app using GitHub Actions" and "What Means YTPlusM and YTPlusM DIY"</em></p>
</details>
